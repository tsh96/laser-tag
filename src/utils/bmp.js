 ...
 * @param {boolean} isFlipped - Whether to flip the image horizontally
 * @returns {Blob} BMP file blob
 */
export function generateBMP(canvas, isFlipped = false) {
...
/**
 * Download a BMP file
 * @param {Blob} blob - The BMP blob
 * @param {string} filename - The filename
 */
export function downloadBMP(blob, filename = 'output.bmp') {
